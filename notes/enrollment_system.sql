...
INSERT INTO `student_info` (`Student_ID`, `First_Name`, `Last_Name`, `Middle_Initial`, `Gender`, `Birthdate`, `Citizenship`, `Civil_Status`, `Email`, `Address`, `Enrolled`, `User_ID`) VALUES
(1, 'Christian Kobe', 'Malonzo', '', '', '2002-08-07', '', 'Single', '', '', 0, 10001),
(2, 'Mark Limuel', 'Lape', '', '', '0000-00-00', '', 'Single', '', '', 0, 10002),
(3, 'Yranimez', 'Repil', '', '', '0000-00-00', '', 'Single', 'yranimezrepil@gmail.com', '', 0, 10003);
...
ALTER TABLE `school_sections`
  ...
  ADD KEY `Foreign_Section_2_Course` (`Course_ID`),
...
--
ALTER TABLE `school_sections`
  ADD CONSTRAINT `Foreign_Section_2_Course` FOREIGN KEY (`Course_ID`) REFERENCES `school_courses` (`Course_ID`) ON UPDATE CASCADE,
  ADD CONSTRAINT `Foreign_Section_2_Semester` FOREIGN KEY (`Semester_ID`) REFERENCES `school_semesters` (`Semester_ID`);
